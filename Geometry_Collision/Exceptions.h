...
#define GM_ASSERT(condition, exception, message) \
if (!(condition)) \
{ \
...
GM_ASSERT(condition, std::domain_error, message)
...
GM_ASSERT(condition, std::invalid_argument, message)
...
GM_ASSERT(condition, std::length_error, message)
...
GM_ASSERT(condition, std::logic_error, message)
...
GM_ASSERT(condition, std::out_of_range, message)
...
GM_ASSERT(condition, std::overflow_error, message)
...
GM_ASSERT(condition, std::range_error, message)
...
GM_ASSERT(condition, std::runtime_error, message)
...
GM_ASSERT(condition, std::underflow_error, message)
